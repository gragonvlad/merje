...
// movement anticheat
TC_GAME_API bool World::m_EnableMvAnticheat = true;
TC_GAME_API uint32 World::m_TeleportToPlaneAlarms = 50;
TC_GAME_API uint32 World::m_MistimingAlarms = 200;
TC_GAME_API uint32 World::m_MistimingDelta = 15000;
/// World constructor
World::World()
{
    m_playerLimit = 0;
...
void World::LoadConfigSettings(bool reload)
{
	...
	m_bool_configs[CONFIG_MULTIBOXING_KICK_ONLY_ON_BG_OR_ARENA] = sConfigMgr->GetBoolDefault("Multiboxing.Kick.Only.On.BG.Or.Arena", true);
